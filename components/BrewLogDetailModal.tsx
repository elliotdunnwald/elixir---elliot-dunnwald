...
const BrewLogDetailModal: React.FC<BrewLogDetailModalProps> = ({ activityId, onClose, onDelete, onEdit }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm overflow-y-auto p-4 sm:p-6"
      onClick={onClose}
    >
      <div className="min-h-full flex items-center justify-center py-10">
        <div
          className="max-w-4xl w-full bg-white rounded-[2.5rem] border border-black shadow-2xl animate-in fade-in duration-300"
